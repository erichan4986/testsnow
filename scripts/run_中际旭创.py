...
STOCK = {
    "name": "中际旭创",
    "code": "300308",
    "xueqiu_code": "SZ300308",
    "gid": "300308",
}
STOCK_NAME = STOCK["name"]

KEYWORDS = ["中际旭创", "光模块", "800G", "1.6T", "AI算力", "硅光"]


def _parse_args(argv=None):
    parser = argparse.ArgumentParser(description="生成中际旭创单股深度报告")
    parser.add_argument(
        "--fast-test",
        action="store_true",
